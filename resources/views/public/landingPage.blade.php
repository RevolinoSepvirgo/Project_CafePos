                ...
                <div class="container">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <div class="row">
                          <div class="col-md-3 col-xs-3 col-sm-3">
                            <a style="padding-top: 0px" class="navbar-brand navBrandText text-uppercase font-weight-bold" href="">
                              <img src="{{ asset('aset/logo/logo db.png') }}" alt="restorant" class="move-up" />
                            </a>
                          </div>
                          <div class="col-md-9 col-sm-9 col-xs-9">
                            <a href="">
                              <img class="img-responsive logo" src="{{ asset('aset/logo/desain bg.png') }}" alt="restorant" style="position: relative; width: 200px !important; height: 45px !important; top: -4px; left: -10px;" />
                            </a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right navBar">
                      <li class="nav-item">
                        <a href="#section0" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Home</a>
                      </li>
                      <li class="nav-item">
                        <a href="#section1" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Offers</a>
                      </li>
                      <li class="nav-item">
                        <a href="#section2" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">About</a>
                      </li>
                      <li class="nav-item">
                        <a href="#section7" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Contact</a>
                      </li>
                      <li class="nav-item">
                        <a href="{{url('login')}}" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Login</a>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="maintext text-center">
            ...
            <p>
              D'Brownies – Surga camilan manis di Padang yang menyajikan brownies dan cookies lezat, fresh dari oven, dengan suasana hangat dan pelayanan ramah.
Cocok untuk bersantai, ngobrol santai, atau bekerja sambil menikmati cita rasa manis yang tak terlupakan. Temukan momen manismu bersama D'Brownies!
    ...
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-5 col-md-offset-1 addess-description">
          ...
          <p>
            Jika ada Informasi Seputar D'Brownies Cafe & Space Silahkan Untuk Hubungi Nomer dan Email di Bawah Ini
          </p>
          <ul>
  ...
  <div class="row">
    ...
    <div class="col-md-10 col-sm-10 col-xs-10 lineHeight">
      ...
      <a href="https://www.instagram.com/d.browniees?igsh=MW1wc3d1OHVoMXNueg==" target="_blank" style="color: #fff; text-decoration: none;">@d.brownies</a>
    </div>
  </div>
</li>
              </div>
      ...
      <div class="row">
        ...
        <div class="footer-bottom text-center">
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <p>Copyright © <a href="https://www.instagram.com/r.linoo_?igsh=djBmZHYyZm00c3du&utm_source=qr" target="_blank">R.lino</a> 2025. All Right Reserved By revolino.</p>
              </div>
            </div>
          </div>
        </div>
