        ...
        <div class="bg-white shadow rounded-lg p-4 flex items-center justify-between stat-card">
            ...
            <div class="p-2 rounded-full bg-yellow-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v8m0 4v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
            </div>
        </div>
    </div>
        ...
        <table class="min-w-full text-sm divide-y divide-gray-200 rounded-lg overflow-hidden">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition-all duration-150">
                    <td class="px-6 py-3 font-medium text-gray-900 whitespace-nowrap">#ORD-{{ $order->id }}</td>
